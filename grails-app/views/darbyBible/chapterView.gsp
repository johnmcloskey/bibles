...
<div class="container">
    <header class="clearfix">
        ...
        <h1>Darby Bible</a> 
		<g:link controller="darbyBible" action="read"> 
    ...
    <div class="main">
        <ul id="cbp-ntaccordion" class="cbp-ntaccordion"> 
            <li>
                ...
                <g:link controller="darbyBible" action="readBook" params="[book: selectedBook]" > 
           			<img src="http://johnmcloskey.com/printer.png"></img>		
              	</g:link>
                Chapter ${selectedChapter.encodeAsHTML()}
                <g:link controller="darbyBible" action="readChapter" params="[book: selectedBook, chapter: selectedChapter]" > 
           			<img src="http://johnmcloskey.com/printer.png"></img>		
              	</g:link>
                </h3>
                ...
                <p>
                    <g:each var="object" in="${chapterMapped}">
                        <b>${object.asType(DarbyBible).verse.encodeAsHTML()}</b> ${object.asType(DarbyBible).verseText.encodeAsHTML()}
                    </g:each>
                </p>
                </div>
            </li>
            <li>
            	<h3>
           			<g:link controller="darbyBible" action="chapterView" params="[book: nextBook, chapter: nextChapter]" >
            			<img src="http://johnmcloskey.com/arrow.png"></img>	
            		</g:link> 
           			${nextBook.encodeAsHTML()} 
           			<g:link controller="darbyBible" action="readBook" params="[book: nextBook]" > 
           				<img src="http://johnmcloskey.com/printer.png"></img>		
              		</g:link>
           			Chapter ${nextChapter.encodeAsHTML()}
           			<g:link controller="darbyBible" action="readChapter" params="[book: nextBook, chapter: nextChapter]" > 
           				<img src="http://johnmcloskey.com/printer.png"></img>		
              		</g:link>
              	</h3>
