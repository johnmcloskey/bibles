...
app.controller("InstantSearchController", function($scope, $http) {
  $http.get('/bibles/basicEnglishBible/searchList').
...
<div class="container">
    <header class="clearfix">
      <a href="/"><h1>Basic English Bible</a></h1>
    </header>
    <div class="main">
		...
		<div ng-app="instantSearch" ng-controller="InstantSearchController">
        	...
        	<ul>
                	<li ng-repeat="i in items | searchFor:searchString">
                        	...
                        	<%-- <g:link target="_blank" controller="basicEnglishBible" action="chapterView" params="[book: 'Exodus', chapter: '1']"> --%>
                			
                			<a target="_blank" href="/bibles/basicEnglishBible/chapterView?book={{i.book}}&chapter={{i.chapter}}"><img ng-src="arrow.png" /></a>
