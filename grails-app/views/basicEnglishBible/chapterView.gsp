<%@ page import="com.johnmcloskey.BasicEnglishBible" %>
...
<div class="container">
    ...
    <a href="/">
        <span>Bible</span>
        <h1>Basic English Bible</a> 
		<g:link controller="basicEnglishBible" action="read"> 
    ...
    <div class="main">
        <ul id="cbp-ntaccordion" class="cbp-ntaccordion">         
            ...
            <li>
                ...
                <g:link controller="basicEnglishBible" action="readBook" params="[book: selectedBook]" > 
           			<img src="http://johnmcloskey.com/printer.png"></img>		
              	</g:link>
                Chapter ${selectedChapter.encodeAsHTML()}
                <g:link controller="basicEnglishBible" action="readChapter" params="[book: selectedBook, chapter: selectedChapter]" > 
           			<img src="http://johnmcloskey.com/printer.png"></img>		
              	</g:link>
              	</h3>
                ...
                <p>
                    <g:each var="object" in="${chapterMapped}">
                        <b>${object.asType(BasicEnglishBible).verse.encodeAsHTML()}</b> ${object.asType(BasicEnglishBible).verseText.encodeAsHTML()}
                    </g:each>
                </p>
                </div>
            </li>
            <li>
           			<h3>         			
           			<g:link controller="basicEnglishBible" action="chapterView" params="[book: nextBook, chapter: nextChapter]" > 
            			<img src="http://johnmcloskey.com/arrow.png"></img>	
            		</g:link>
           			${nextBook.encodeAsHTML()} 
           			<g:link controller="basicEnglishBible" action="readBook" params="[book: nextBook]" > 
           				<img src="http://johnmcloskey.com/printer.png"></img>		
              		</g:link>
           			Chapter ${nextChapter.encodeAsHTML()}
           			<g:link controller="basicEnglishBible" action="readChapter" params="[book: nextBook, chapter: nextChapter]" > 
           				<img src="http://johnmcloskey.com/printer.png"></img>		
              		</g:link>
					</h3> 
