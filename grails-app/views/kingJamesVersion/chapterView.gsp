<%@ page import="com.johnmcloskey.KingJamesVersion" %>
...
<div class="container">
    <header class="clearfix">
        ...
        <h1>King James Version</a>         
        <g:link controller="kingJamesVersion" action="read" > 
    ...
    <div class="main">
        <ul id="cbp-ntaccordion" class="cbp-ntaccordion">
                ...
                <g:link controller="kingJamesVersion" action="readBook" params="[book: selectedBook]" > 
           			<img src="http://johnmcloskey.com/printer.png"></img>		
              	</g:link>                
                Chapter ${selectedChapter.encodeAsHTML()}
                <g:link controller="kingJamesVersion" action="readChapter" params="[book: selectedBook, chapter: selectedChapter]" > 
           			<img src="http://johnmcloskey.com/printer.png"></img>		
              	</g:link>
                </h3>
                ...
                <p>
                    <g:each var="object" in="${chapterMapped}">
                        <b>${object.asType(KingJamesVersion).verse.encodeAsHTML()}</b> ${object.asType(KingJamesVersion).verseText.encodeAsHTML()}
                    </g:each>
                </p>
                </div>
            </li>                            
            <li>
           		<h3>         			           			
           			<g:link controller="kingJamesVersion" action="chapterView" params="[book: nextBook, chapter: nextChapter]" > 
            			<img src="http://johnmcloskey.com/arrow.png"></img>	
            		</g:link>
           			${nextBook.encodeAsHTML()}            			
           			<g:link controller="kingJamesVersion" action="readBook" params="[book: nextBook]" > 
           				<img src="http://johnmcloskey.com/printer.png"></img>		
              		</g:link>
           			Chapter ${nextChapter.encodeAsHTML()}
           			<g:link controller="kingJamesVersion" action="readChapter" params="[book: nextBook, chapter: nextChapter]" > 
           				<img src="http://johnmcloskey.com/printer.png"></img>		
              		</g:link>
              	</h3> 	
