<%@ page import="com.johnmcloskey.WorldEnglishBible" %>
...
<div class="container">
    <header class="clearfix">
        ...
        <h1>World English Bible</a> 
		<g:link controller="worldEnglishBible" action="read"> 
    ...
    <div class="main">
        <ul id="cbp-ntaccordion" class="cbp-ntaccordion"> 
            ...
            <li>
                ...
                <g:link controller="worldEnglishBible" action="readBook" params="[book: selectedBook]" > 
           			<img src="http://johnmcloskey.com/printer.png"></img>		
              	</g:link>
                Chapter ${selectedChapter.encodeAsHTML()}
                <g:link controller="worldEnglishBible" action="readChapter" params="[book: selectedBook, chapter: selectedChapter]" > 
           			<img src="http://johnmcloskey.com/printer.png"></img>		
              	</g:link></h3>
                <div class="cbp-ntcontent">
                <p>
                    <g:each var="object" in="${chapterMapped}">
                        <b>${object.asType(WorldEnglishBible).verse.encodeAsHTML()}</b> ${object.asType(WorldEnglishBible).verseText.encodeAsHTML()}
                    </g:each>
                </p>
                </div>
            </li>
            <li>
           			<h3>         			
           			<g:link controller="worldEnglishBible" action="chapterView" params="[book: nextBook, chapter: nextChapter]" > 
